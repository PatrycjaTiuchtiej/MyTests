...
import com.example.mytests.adapter.ResultStudentAdapter;
import com.example.mytests.databinding.FragmentResultStudentListBinding;
import com.example.mytests.model.ResultModel;
import com.example.mytests.viewmodel.ResultViewModel;

import java.util.List;

public class ResultStudentFragment extends Fragment implements ResultStudentAdapter.OnItemClickedListener {

    private FragmentResultStudentListBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentResultStudentListBinding.inflate(inflater, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new ResultStudentAdapter(this);
